...
export default function EffectsDemo() {
  ...
  return (
    ...
    >
      ...
      >
        Démonstration des composants d&apos;animation et d&apos;effets 3D avec
        Framer Motion
      </Paragraph>
        ...
        {[
          {
            ...
            icon: (
              <BulbOutlined style={{ fontSize: "24px", color: "#7745FF" }} />
            ),
            description:
              "Exploitez les derniers modèles d'IA pour créer des assistants intelligents.",
          },
          {
            title: "Voix naturelle",
            icon: (
              <ThunderboltOutlined
                style={{ fontSize: "24px", color: "#5769FF" }}
              />
            ),
            description:
              "Des voix synthétiques ultra-réalistes pour vos assistants.",
          },
          {
            title: "Intégration simple",
            icon: (
              <RocketOutlined style={{ fontSize: "24px", color: "#9CB8FF" }} />
            ),
      ...
      <Divider orientation="left" style={{ marginTop: "60px" }}>
        Éléments flottants
      </Divider>
        ...
        <FloatingElement amplitude={15} duration={3}>
          <Card style={{ width: "300px", textAlign: "center" }}>
            ...
            <Paragraph style={{ marginTop: "16px" }}>
              AlloKoli a transformé notre stratégie d&apos;assistance client.
      ...
      >
        <div
          style={{
            background:
              "linear-gradient(135deg, rgba(119, 69, 255, 0.1), rgba(87, 105, 255, 0.2))",
            height: "100%",
            width: "100%",
            display: "flex",
            justifyContent: "center",
        ...
        <div style={{ position: "absolute", top: "20%", left: "15%" }}>
          <Title level={2} style={{ color: "#7745FF" }}>
            Parallax
          </Title>
        </div>

        <div style={{ position: "absolute", bottom: "25%", right: "10%" }}>
          <Title level={3} style={{ color: "#5769FF" }}>
            Effet de profondeur
          </Title>
        </div>
        ...
        <div style={{ position: "absolute", top: "60%", left: "30%" }}>
          <Card>
            <Paragraph>
              L&apos;effet parallax crée une sensation de profondeur et
              d&apos;immersion.
            </Paragraph>
          </Card>
        </div>
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <Paragraph style={{ fontSize: "18px" }}>
            Ce gradient d&apos;arrière-plan change lentement pour créer un effet
            vivant et dynamique.
          </Paragraph>
          <Space>
      ...
      <Divider orientation="left" style={{ marginTop: "60px" }}>
        Éléments apparaissant au scroll
      </Divider>
          ...
          <Col xs={24} sm={12} key={index}>
            ...
            >
              <Card title={`Animation depuis ${direction}`}>
                <Paragraph>
                  Cet élément apparaît avec une animation lorsqu&apos;il entre
                  dans la vue. Essayez de défiler pour voir l&apos;effet se
                  reproduire.
                </Paragraph>
              </Card>
            </AppearingElement>
