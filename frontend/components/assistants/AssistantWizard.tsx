...
import { Form, Button, Alert, Typography, Space, Steps, FormInstance, Card, Divider } from 'antd';
...
interface WizardStep {
  ...
  validationSchema?: {
    required?: string[];
    validator?: (values: Partial<AssistantFormData>) => { error: boolean; message?: string };
  };
}
...
const AssistantWizard: React.FC<AssistantWizardProps> = ({
  ...
  const [formData, setFormData] = useState<Partial<AssistantFormData>>(initialValues);
