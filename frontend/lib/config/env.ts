...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_USE_DEMO_DATA: z.string().transform(val => val === 'true').default('false'),
})
...
function validateEnv(): Environment {
  // DEBUG: Affichage des variables d'environnement pour le débogage
  console.log('=== DÉBOGAGE VARIABLES D\'ENVIRONNEMENT ===');
  console.log('NEXT_PUBLIC_SUPABASE_URL:', process.env.NEXT_PUBLIC_SUPABASE_URL);
  console.log('NEXT_PUBLIC_SUPABASE_ANON_KEY:', process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? 'SET (longueur: ' + process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY.length + ')' : 'NOT SET');
  ...
  try {
    ...
    console.log('envObject.NEXT_PUBLIC_SUPABASE_URL:', envObject.NEXT_PUBLIC_SUPABASE_URL);
    console.log('envObject.NEXT_PUBLIC_SUPABASE_ANON_KEY:', envObject.NEXT_PUBLIC_SUPABASE_ANON_KEY ? 'SET' : 'NOT SET');
