...
import { Bot, ArrowRight, Check, Phone, Code, Lock, Rocket, Sparkles, Plus, Minus } from 'lucide-react';
import { 
  Typography, 
  Button, 
  Row, 
...
const theme = {
  ...
  components: {
    ...
    Typography: {
      colorText: '#1B1D2A',
      fontFamilyHeading: "'Sora', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
...
const features = [
  {
    ...
    description: 'Construisez vos scénarios conversationnels avec une interface intuitive de type Drag & Drop. Aucune compétence technique requise pour créer des flux conversationnels complets.',
    icon: Sparkles,
    iconColor: '#7745FF',
  },
  {
    title: 'Multicanal',
    description: 'Gérez tous vos canaux de communication depuis une interface unique : téléphonie, WhatsApp, Messenger et plus encore. Offrez une expérience client cohérente sur tous les points de contact.',
    icon: Phone,
    iconColor: '#5769FF',
  },
  {
    title: 'Intelligence Artificielle',
    description: 'Notre plateforme intègre des moteurs NLP avancés pour comprendre, analyser et répondre naturellement à vos clients. Détection automatique des intentions et gestion des demandes complexes.',
    icon: Bot,
    iconColor: '#7745FF',
  },
  {
    title: 'Déploiement Rapide',
    description: 'En moins de 5 minutes, votre assistant est opérationnel. Aucun serveur à configurer, aucune installation technique : tout est géré depuis votre navigateur.',
    icon: Rocket,
    iconColor: '#5769FF',
  },
  {
    title: 'Sécurité Maximale',
    description: 'Données hébergées en Europe sur des serveurs sécurisés, conformes aux dernières réglementations RGPD. Protection et confidentialité garanties pour toutes vos interactions.',
    icon: Lock,
    iconColor: '#7745FF',
  },
  {
    title: 'Intégrations',
    description: 'Connectez facilement vos assistants à vos outils existants : CRM, ERP, Helpdesk, Google Calendar et plus. API disponible pour des intégrations personnalisées.',
    icon: Code,
    iconColor: '#5769FF',
  },
];
  ...
  return (
    <ConfigProvider theme={theme}>
      ...
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Exo+2:wght@400;500;600;700&family=Manrope:wght@400;500;600;700&family=Sora:wght@400;500;600;700&display=swap" rel="stylesheet" />
      </Head>
      ...
      <Layout style={{ 
        ...
        <Header style={headerStyle}>
          <div style={headerContainerStyle}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <Typography.Text strong style={{ fontSize: '20px', color: '#1B1D2A', fontFamily: "'Exo 2', sans-serif" }}>
                AlloKoli
              </Typography.Text>
          </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <Link href="#how-it-works" style={{ color: '#1B1D2A', textDecoration: 'none' }}>
              Comment ça marche
            </Link>
        ...
        <Content style={{ position: 'relative', zIndex: 1, paddingTop: '32px' }}>
            ...
            transition={{ duration: 0.8 }}
                ...
                >
                  ...
                  <Paragraph style={{ fontSize: '18px', color: 'rgba(27, 29, 42, 0.8)', margin: 0 }}>
                    Avec AlloKoli, révolutionnez la façon dont votre entreprise gère ses interactions clients. Notre plateforme CCaaS vous permet de créer, configurer et déployer des assistants conversationnels intelligents sur téléphone, WhatsApp, Messenger et d&apos;autres canaux populaires, sans aucune compétence technique requise.
                  </Paragraph>
                  ...
                  <Space direction="vertical" size={16}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <Text style={{ color: 'rgba(27, 29, 42, 0.8)' }}>Données hébergées en Europe</Text>
              </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <div style={{
                        width: '24px',
                      ...
                      <Text style={{ color: 'rgba(27, 29, 42, 0.8)' }}>Déjà +200 entreprises séduites</Text>
              </div>
                  </Space>
          ...
          <div id="how-it-works" style={{ padding: '96px 24px' }}>
            <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
                ...
                <Col xs={24} md={12} lg={6}>
                  ...
                  >
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <Title level={4} style={{ color: '#1B1D2A', marginBottom: '12px' }}>
                        Créez votre agent
                      </Title>
                      <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                        Utilisez notre assistant guidé pour nommer votre agent et choisir ses canaux de communication.
                      </Paragraph>
                    </div>
                  </motion.div>
                </Col>
                ...
                <Col xs={24} md={12} lg={6}>
                  ...
                  >
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                        Sélectionnez des modèles prêts à l&apos;emploi ou utilisez l&apos;éditeur Drag & Drop pour créer des flux sur mesure.
                      </Paragraph>
                    </div>
                  </motion.div>
                </Col>
                ...
                <Col xs={24} md={12} lg={6}>
                  ...
                  >
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                        Activez votre assistant sur les canaux souhaités (téléphonie, WhatsApp, Messenger...) d&apos;un simple clic.
                      </Paragraph>
                    </div>
                  </motion.div>
                </Col>
                ...
                <Col xs={24} md={12} lg={6}>
                  ...
                  >
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                        Consultez les statistiques en temps réel et modifiez vos scénarios à la volée pour améliorer les performances.
                      </Paragraph>
                    </div>
                  </motion.div>
                </Col>
              ...
              <div style={{ textAlign: 'center', marginTop: '64px' }}>
                <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)', maxWidth: '768px', margin: '0 auto 24px' }}>
                  En 10 minutes seulement, un salon de coiffure peut créer un assistant pour gérer les rendez-vous, répondre aux questions sur les horaires et transmettre les demandes urgentes à l&apos;équipe.
                </Paragraph>
            <Link href="/dashboard">
          ...
          {/* FAQ Section */}
          <div id="faq" style={{ padding: '96px 24px', background: 'linear-gradient(to right, rgba(242, 245, 255, 0.5), rgba(247, 247, 252, 0.5))' }}>
            <div style={{ maxWidth: '1024px', margin: '0 auto' }}>
              ...
              <Collapse 
                ...
                expandIcon={({ isActive }) => isActive ? 
                  <Minus style={{ color: '#7745FF', width: '20px', height: '20px' }} /> : 
                  <Plus style={{ color: '#7745FF', width: '20px', height: '20px' }} />
                }
                style={{ background: 'transparent' }}
                items={[
                  {
                    key: '1',
                    label: <Text strong style={{ fontSize: '18px' }}>Combien de temps pour déployer un assistant ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      Moins de 5 minutes : tout se fait en ligne, sans installation ni compétences techniques. Nommez votre agent, choisissez ses canaux et configurez ses réponses, c&apos;est prêt !
                    </Paragraph>,
                  },
                  {
                    key: '2',
                    label: <Text strong style={{ fontSize: '18px' }}>Dois-je savoir coder ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      Absolument pas. Notre interface No Code a été conçue pour les non-techniciens. Tout se fait par glisser-déposer et paramétrage visuel.
                    </Paragraph>,
                  },
                  {
                    key: '3',
                    label: <Text strong style={{ fontSize: '18px' }}>Où sont stockées les données ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      Les données sont hébergées exclusivement en Europe, sur des serveurs conformes RGPD. Nous garantissons la sécurité et la confidentialité de toutes vos informations.
                    </Paragraph>,
                  },
                  {
                    key: '4',
                    label: <Text strong style={{ fontSize: '18px' }}>Quels canaux sont compatibles ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      AlloKoli prend en charge la téléphonie, WhatsApp, Messenger, Webchat, Email et plus encore. Vous pouvez activer ces canaux selon vos besoins et votre forfait.
                    </Paragraph>,
                  },
                  {
                    key: '5',
                    label: <Text strong style={{ fontSize: '18px' }}>Puis-je intégrer mon CRM ou un logiciel métier ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      Oui, de nombreuses intégrations sont disponibles en natif (Salesforce, HubSpot, Microsoft Dynamics...) ou via notre API pour des connexions personnalisées avec vos outils existants.
                    </Paragraph>,
                  },
                  {
                    key: '6',
                    label: <Text strong style={{ fontSize: '18px' }}>L&apos;assistance est-elle comprise ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      Oui, notre équipe vous accompagne à chaque étape, de la création à l&apos;optimisation de vos assistants. Un support technique est disponible par chat et email pour tous nos clients.
                    </Paragraph>,
                  },
                  {
                    key: '7',
                    label: <Text strong style={{ fontSize: '18px' }}>Puis-je tester gratuitement ?</Text>,
                    children: <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)' }}>
                      Bien sûr : inscrivez-vous et profitez d&apos;une période d&apos;essai sans engagement. Accédez à toutes les fonctionnalités et créez votre premier assistant pour l&apos;évaluer en conditions réelles.
                    </Paragraph>,
                  },
                ]}
              />
            ...
            <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
              <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                ...
                <Paragraph style={{ 
                  ...
                  Plus de 200 entreprises ont choisi AlloKoli pour moderniser leur relation client
                </Paragraph>
              </div>
                    ...
                    >
                      <div style={{ marginBottom: '20px' }}>
                        <div style={{ display: 'flex', marginBottom: '16px' }}>
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg key={star} width="20" height="20" viewBox="0 0 20 20" fill="#FFD700">
                              <path d="M10 1L13 7L19 8L14.5 13L16 19L10 16L4 19L5.5 13L1 8L7 7L10 1Z" />
                            </svg>
                          ))}
                        </div>
                                                 <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)', fontSize: '16px' }}>
                          &quot;En moins de 10 minutes, j&apos;ai mis en place un standard téléphonique intelligent pour mon cabinet. Les patients laissent leurs messages et reçoivent une confirmation par SMS.&quot;
                        </Paragraph>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div style={{ 
                          ...
                          <Text style={{ fontSize: '18px', fontWeight: 'bold', color: '#7745FF' }}>S</Text>
                        </div>
          <div>
                          <Text strong style={{ display: 'block', fontSize: '16px' }}>Sophie</Text>
                          <Text style={{ color: 'rgba(27, 29, 42, 0.6)' }}>Dentiste à Lyon</Text>
          </div>
                      </div>
                    </Card>
                  </motion.div>
                          ...
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg key={star} width="20" height="20" viewBox="0 0 20 20" fill="#FFD700">
                              <path d="M10 1L13 7L19 8L14.5 13L16 19L10 16L4 19L5.5 13L1 8L7 7L10 1Z" />
                                                 ...
                                                 <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)', fontSize: '16px' }}>
                          &quot;Grâce à AlloKoli, nous avons automatisé la prise de rendez-vous et le suivi des commandes sur WhatsApp et Messenger. Notre équipe a divisé par deux le temps passé au téléphone !&quot;
                        </Paragraph>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div style={{ 
                          ...
                          <Text style={{ fontSize: '18px', fontWeight: 'bold', color: '#5769FF' }}>H</Text>
                        </div>
          <div>
                          <Text strong style={{ display: 'block', fontSize: '16px' }}>Hugo</Text>
                          <Text style={{ color: 'rgba(27, 29, 42, 0.6)' }}>Responsable service client</Text>
          </div>
                      </div>
                    </Card>
                  </motion.div>
                          ...
                          {[1, 2, 3, 4, 5].map((star) => (
                            <svg key={star} width="20" height="20" viewBox="0 0 20 20" fill="#FFD700">
                              <path d="M10 1L13 7L19 8L14.5 13L16 19L10 16L4 19L5.5 13L1 8L7 7L10 1Z" />
                                                 ...
                                                 <Paragraph style={{ color: 'rgba(27, 29, 42, 0.7)', fontSize: '16px' }}>
                          &quot;Notre agence immobilière utilise AlloKoli pour répondre aux demandes 24/7, qualifier les clients potentiels et organiser des visites. Nos agents sont plus productifs et nos clients apprécient la réactivité.&quot;
                        </Paragraph>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center' }}>
                        <div style={{ 
                          ...
                          <Text style={{ fontSize: '18px', fontWeight: 'bold', color: '#7745FF' }}>M</Text>
                        </div>
          <div>
                          <Text strong style={{ display: 'block', fontSize: '16px' }}>Mathilde</Text>
                          <Text style={{ color: 'rgba(27, 29, 42, 0.6)' }}>Directrice agence immobilière</Text>
                        </div>
                      </div>
                    </Card>
                  </motion.div>
          ...
          <div id="pricing" style={{ padding: '96px 24px', background: 'linear-gradient(to right, rgba(242, 245, 255, 0.5), rgba(247, 247, 252, 0.5))' }}>
            <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
              <div style={{ textAlign: 'center', marginBottom: '64px' }}>
                <Title level={2} style={{ color: '#1B1D2A', marginBottom: '16px' }}>
              ...
              <Row gutter={[32, 32]} align="stretch">
                  ...
                  >
                    ...
                    >
                      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                        <Text style={{ color: '#7745FF', fontWeight: 'bold', fontSize: '16px', fontFamily: "'Exo 2', sans-serif" }}>STARTER</Text>
                        <Title level={2} style={{ marginTop: '8px', marginBottom: '8px' }}>
                          29€ <Text style={{ fontSize: '16px', fontWeight: 'normal', color: 'rgba(27, 29, 42, 0.6)' }}>/mois</Text>
                        </Title>
                        <Paragraph style={{ color: 'rgba(27, 29, 42, 0.6)' }}>Idéal pour les petites entreprises</Paragraph>
                      </div>

                      <div style={{ marginBottom: '32px' }}>
                        <Space direction="vertical" size={12}>
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                            <Check style={{ color: '#7745FF', width: '20px', height: '20px', flexShrink: 0, marginTop: '4px' }} />
                ...
                <Col xs={24} md={8}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                        <Text style={{ color: '#7745FF', fontWeight: 'bold', fontSize: '16px', fontFamily: "'Exo 2', sans-serif" }}>BUSINESS</Text>
                        <Title level={2} style={{ marginTop: '8px', marginBottom: '8px' }}>
                          99€ <Text style={{ fontSize: '16px', fontWeight: 'normal', color: 'rgba(27, 29, 42, 0.6)' }}>/mois</Text>
                        </Title>
                        <Paragraph style={{ color: 'rgba(27, 29, 42, 0.6)' }}>Pour les entreprises en croissance</Paragraph>
                      </div>
                ...
                <Col xs={24} md={8}>
                  ...
                  >
                    ...
                    >
                      <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                        <Text style={{ color: '#7745FF', fontWeight: 'bold', fontSize: '16px', fontFamily: "'Exo 2', sans-serif" }}>ENTERPRISE</Text>
                        <Title level={2} style={{ marginTop: '8px', marginBottom: '8px' }}>
                          Sur mesure
                        </Title>
                        <Paragraph style={{ color: 'rgba(27, 29, 42, 0.6)' }}>Pour les besoins avancés</Paragraph>
                      </div>
                      ...
                      <div style={{ marginBottom: '32px' }}>
                        <Space direction="vertical" size={12}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px' }}>
                            <Check style={{ color: '#7745FF', width: '20px', height: '20px', flexShrink: 0, marginTop: '4px' }} />
                            <Text>API avancée et intégrations personnalisées</Text>
                          </div>
                        </Space>
                      </div>
        ...
        >
          ...
          >
              ...
              Testez AlloKoli dès aujourd&apos;hui : créez votre premier assistant IA en quelques minutes et découvrez comment notre solution peut booster vos performances tout en simplifiant votre gestion.
                  </Paragraph>
                  <Paragraph style={{ 
                    fontSize: '16px', 
              ...
              Garantie satisfait ou remboursé pendant la période d&apos;essai. Plus de 200 entreprises ont déjà adopté AlloKoli pour leur relation client.
                  </Paragraph>
            <Link href="/dashboard">
                    <Button 
                      type="primary" 
