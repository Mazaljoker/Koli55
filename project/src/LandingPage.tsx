...
import { Bot, ArrowRight, Check, Shield, Zap, Globe, Headphones, MessageSquare, ChevronDown, ChevronUp, Phone, Droplet as DragDrop, Code, Lock, Rocket, Sparkles, Laptop } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f7f9fb] to-white overflow-hidden">
      ...
      <header className="fixed w-full bg-white/80 backdrop-blur-sm z-50 px-6 py-4 border-b border-gray-100">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <button className="bg-[#435175] text-white px-6 py-2 rounded-lg hover:bg-[#5b6a91] transition-colors">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FadeInWhenVisible>
              <div className="text-center">
                <div className="w-16 h-16 bg-[#435175] rounded-full flex items-center justify-center mx-auto mb-4">
                  <DragDrop className="h-8 w-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold mb-2">1. Configuration</h3>
            ...
            <FadeInWhenVisible>
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">2. Canaux</h3>
                <p className="text-gray-600">
            ...
            <FadeInWhenVisible>
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">3. Déploiement</h3>
                <p className="text-gray-600">
